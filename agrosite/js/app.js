...
var CELULAR_EMPRESA = '5543999814186';
...
cardapio.metodos = {
    ...
    adicionarAoCarrinho: (id) => {
        ...
        if(qntdAtual > 0){
            ...
            if(item.length > 0){
                ...
                // caso já exista, apenas altera a quantidade
                if(existe.length >0){
                ...
                cardapio.metodos.mensagem('Item adcionado no carrinho!', 'green');
                $("#qntd-" + id).text(0);
    ...
    // atualizar os valores dos botões no carrinho
    atualizarBadgeTotal: () => {
        var total = 0;
    ...
    // botão rermover item do carrinho
    removerItemCarrinho: (id) => {
        ...
        // atualiza o botão com a quantidade atualizada
        cardapio.metodos.atualizarBadgeTotal();
    },
